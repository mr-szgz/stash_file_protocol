<!--
source: https://developer.chrome.com/articles/url-protocol-handler
retrieved: 2026-04-01T21:27:18.987418+00:00
final_url: https://developer.chrome.com/docs/web-platform/best-practices/url-protocol-handler
content_type: text/html
-->

# URL protocol handler registration for PWAs  |  Web Platform  |  Chrome for Developers

[Skip to main content](https://developer.chrome.com/docs/web-platform/best-practices/url-protocol-handler#main-content)
...
#  URL protocol handler registration for PWAs  Stay organized with collections  Save and categorize content based on your preferences. 

Let installed PWAs handle links that use a specific protocol for a more integrated experience.

 Thomas Steiner 

[https://github.com/tomayac](https://github.com/tomayac)[https://www.linkedin.com/in/thomassteinerlinkedin](https://www.linkedin.com/in/thomassteinerlinkedin)[https://toot.cafe/@tomayac](https://toot.cafe/@tomayac)[https://bsky.app/profile/tomayac.com](https://bsky.app/profile/tomayac.com)[https://blog.tomayac.com/](https://blog.tomayac.com/)
...
The present URL protocol handler registration for PWAs  mechanism is about offering protocol handler registration as part of a PWA installation through its manifest. After registering a PWA as a protocol handler, when a user clicks on a hyperlink with a specific scheme such as `mailto` , `bitcoin`, or `web+music` from a browser or a platform-specific app, the registered PWA will open and receive the URL. It is important to note that both the proposed manifest-based registration and the traditional `registerProtocolHandler()` play very similar roles in practice, while still allowing the possibility for complementary user-experiences:
...
Did you find a bug with Chromium's implementation? Or is the implementation different from the spec? File a bug at [new.crbug.com](https://new.crbug.com) . Be sure to include as much detail as you can, simple instructions for reproducing, and enter `UI>Browser>WebAppInstalls` in the Components  box.
...
- [Spec draft](https://github.com/w3c/manifest/pull/972)
